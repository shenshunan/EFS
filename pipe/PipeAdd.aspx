<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PipeAdd.aspx.cs" Inherits="Pipe_orderAdd" %>
...
<script type="text/javascript" src="../js/EditorGridPanel.js"></script>
...
function doOrderProOk()
{
  if(Efs.getExt("frmPro").isValid())
  {
    ...
    orderProDom.getElementsByTagName("DATAINFO")[0].appendChild(frmProDom.getElementsByTagName("PIPELINEDETAIL")[0]);
...
function doOrderProOk1() {
    if (Efs.getExt("frmPro1").isValid()) {
        ...
        orderProDom.getElementsByTagName("DATAINFO")[0].appendChild(frmProDom.getElementsByTagName("PIPELINEDETAIL1")[0]);
...
<div xtype="tabpanel" region="center"   height="215" iconCls="icon-panel" title="添加管道数据" border="true">
  ...
  <form id="frmPost" class="efs-box" method="post" url="../sysadmin/baseRefWeb.aspx?method=OrdersAdd" onEfsSuccess="frmPostSubBack(true)" onEfsFailure="frmPostSubBack(false)">
      ...
      <input id="personid" type="hidden" kind="text" fieldname="PIPELINE/PIPEID" operation="0" writeevent="0">
	</form>    
   </div>
   <div id="tab2" title="管体参数">
  <form id="Form1" class="efs-box" method="post" url="../sysadmin/baseRefWeb.aspx?method=OrdersAdd" onEfsSuccess="frmPostSubBack(true)" onEfsFailure="frmPostSubBack(false)">
      <TABLE class="formArea">
        <tr>
  ...
  <form id="Form2" class="efs-box" method="post" url="../sysadmin/baseRefWeb.aspx?method=OrdersAdd" onEfsSuccess="frmPostSubBack(true)" onEfsFailure="frmPostSubBack(false)">
      <TABLE class="formArea">
        <tr>
          <td colspan="8">管段(KP位置)</td>       
        </tr>       
  ...
  <form id="Form3" class="efs-box" method="post" url="../sysadmin/baseRefWeb.aspx?method=OrdersAdd" onEfsSuccess="frmPostSubBack(true)" onEfsFailure="frmPostSubBack(false)">
      <TABLE class="formArea">
        <tr>
          <td>介质类型</td>
...
<div iconCls="icon-panel" id="orderProAdd" xtype="window" width="760" height="300" title="添加内检记录">
  <div xtype="tbar">
   ...
   <form id="frmPro" class="efs-box" method="post">
      ...
      <input type="hidden" kind="text" fieldname="PIPELINEDETAIL/PIPEID" operation="0" writeevent="0">
	</form>     
</div>
...
<div iconCls="icon-panel" id="orderProAdd1" xtype="window" width="760" height="300" title="添加外检记录">
  <div xtype="tbar">
   ...
   <form id="frmPro1" class="efs-box" method="post">
      ...
      <input type="hidden" kind="text" fieldname="PIPELINEDETAIL1/PIPEID" operation="0" writeevent="0">
	</form>     
</div>
