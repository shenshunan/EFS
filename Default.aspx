                ...
                <TD height=180 valign="bottom">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
                    ...
                    <TR height=24>
                      ...
                      <TD width=100>
                      <INPUT name="txtUserName" id="txtUserName" maxlength="30" class="TextBorder" onkeydown="return doKeyDown()" onfocus="this.select()" >
                      </TD>
                      <TD width=480>&nbsp;</TD>
                    </TR>
                    <TR height=24>
                      ...
                      <TD width=100><INPUT type="password" name="txtUserPWD" id="txtUserPWD" maxlength="30" class="TextBorder" onkeydown="return doKeyDown()" onfocus="this.select()" >
             </TD>
