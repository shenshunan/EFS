...
window.onload = function () {
    window.setInterval(function () {
        if (famRMain.document.getElementById("ext-comp-1008")!=null)
            famRMain.document.getElementById("ext-comp-1008").style.display = "none";
    }, 200);
}
</script>
...
<table background="images/hd-bg.gif" width="100%" cellpadding="0" cellspacing="0" height="57">
    <tr>
      <td class="title" width="500px" >海底管道数据库及完整性评估系统
      </td>
      <td valign="middle" align="right" width="*">
        <TABLE cellpadding="0" cellspacing="0" height="100%">
        <TR>
          <TD width="16"><img src="images/default/dd/home.gif"></TD>
          <TD style="padding-top:4px;padding-left:2px;"><a target="famRMain" href="task.aspx">首页</a></TD>
          <TD width="12px;">&nbsp;&nbsp;</TD>
          ...
          <TD style="padding-top:4px;padding-left:2px;"><a style="cursor:pointer;" onclick="doHelp()" >帮助</a></TD>
          <TD width="12px;">&nbsp;&nbsp;</TD>
